import {isEvent, getHandler } from "./utils";
...
/**
 * @param {{validators: Function|Function[]|null, updateOn: 'change' | 'blur' | 'submit'}} validatorOrOpts
 * @return {Boolean}
 */
...
export class AbstractControl {
  ...
  /**
   * Sets the validators that are active on this control.  Calling
  ...
  /**
   * @param {{validators: Function|Function[]|null, updateOn: 'change(default)' | 'blur' | 'submit'}} opts
   * @return {Void}
   */
...
export class FormGroup extends AbstractControl {
  constructor(controls, validatorOrOpts) {
    super(
      coerceToValidator(validatorOrOpts),
    );
